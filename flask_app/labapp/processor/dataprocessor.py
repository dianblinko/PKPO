...
class NoneDataProcessor(DataProcessor):
    ...
    def run(self):
        ...
        self.result_country = pandas.DataFrame(columns=['country', 'sex', 'gdp_per_capita', 'suicides_no', 'population', 'Suicides/100KPopulation', 'Level_gdp'])
        self.result_year = pandas.DataFrame(columns=['year', 'sex', 'suicides_no', 'population', 'Suicides/100KPopulation'])
        self.result_age = pandas.DataFrame(columns=['age', 'sex', 'suicides_no', 'population', 'Suicides/100KPopulation'])
